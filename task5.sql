...
select avg(purch_amt) as avarage_purchase from orders; 

select count(*) as customer_number from customers where name is not null; 
...
select customers.* from customers join orders o on customers.customer_id = o.customer_id where o.purch_amt > 10; 
